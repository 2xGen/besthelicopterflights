...
import {
  getMauiOperatorTours,
  MAUI_OPERATORS_PATH,
  mauiOperatorComparisons,
  mauiOperators,
} from "@/data/maui-operators";
import { createPageMetadata } from "@/lib/seo";
import { VIATOR_LINK_REL, viatorAffiliateUrl } from "@/lib/viator";

export const metadata = createPageMetadata({
  title: "Best Helicopter Tour Operators on Maui (2026)",
  description:
    "Compare Maui helicopter tour operators — Air Maui, Blue Hawaiian, Maverick and Temptation Tours — plus head-to-head operator comparisons.",
  path: MAUI_OPERATORS_PATH,
  keywords: [
    "maui helicopter tour operators",
    "maui helicopter companies",
    "best helicopter company maui",
    "air maui vs blue hawaiian",
    "blue hawaiian maui",
...
export default function MauiOperatorsPage() {
  return (
    <>
      <Header variant="solid" />
      <main className="flex-1 min-w-0 w-full max-w-full pt-[4.25rem]">
        <MauiCategoryNav currentPath={MAUI_OPERATORS_PATH} />
        ...
        <section className="bg-navy-deep px-5 pb-14 pt-12 text-white md:px-8 md:pb-20 md:pt-16">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/80 md:text-lg">
              ...
              which helicopter company should you book with on Maui? We compare
        ...
        <section className="bg-mist px-5 py-12 md:px-8 md:py-16">
          <div className="mx-auto max-w-6xl">
            <h2 className="font-display text-2xl text-navy md:text-3xl">
              Maui helicopter companies at a glance
            </h2>
            <ul className="mt-8 space-y-3 md:hidden">
              {mauiOperators.map((operator) => (
                <li
                  key={operator.id}
        ...
        <section className="bg-mist-soft px-5 py-14 md:px-8 md:py-20">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-stone">
              ...
              specific tours from that operator in our current Maui research
              set.
            </p>

            <div className="mt-10 space-y-8">
              {mauiOperators.map((operator) => {
                const tours = getMauiOperatorTours(operator);
                return (
                  <article
                    key={operator.id}
                    id={operator.id}
        ...
        <section className="bg-mist px-5 py-14 md:px-8 md:py-20">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-12 space-y-14">
              {mauiOperatorComparisons.map((comparison) => (
                <article
                  key={comparison.id}
                  id={comparison.id}
