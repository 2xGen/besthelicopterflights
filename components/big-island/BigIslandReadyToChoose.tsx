...
export function BigIslandReadyToChoose() {
  return (
    <section className="bg-navy px-5 py-16 text-white md:px-8 md:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/75 md:text-lg">
          ...
          in our featured Big Island comparison. Each link opens the exact
          product listing for that flight, so you can review dates, seats and
          current pricing in one step.
        </p>
