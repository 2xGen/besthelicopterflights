import { featuredMauiTours } from "@/data/maui-tours";
import { VIATOR_LINK_REL, viatorAffiliateUrl } from "@/lib/viator";

export function MauiComparisonTable() {
  return (
    <section
      id="comparison"
    ...
    >
      <div className="mx-auto w-full min-w-0 max-w-6xl">
        ...
        <p className="mt-5 max-w-3xl text-base leading-relaxed text-stone md:text-lg">
          ...
          clarity (doors-off, landings, East Maui vs West Maui / Molokai), and
          value relative to experience — not Viator’s default listing order.
          “Best for” labels explain why each tour earns its place.
        </p>

        <ul className="mt-10 space-y-3 md:hidden">
          {featuredMauiTours.map((tour) => (
            <li
              key={tour.id}
